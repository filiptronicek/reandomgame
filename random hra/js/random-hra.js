...
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> In this round you got "+ rndhra.score+ " points. That's not bad, but it can be better."
} else if (rndhra.score > 35) {
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> In this round you got "+ rndhra.score+ " points. Very good result. Congratulations. ";
} else if (rndhra.score < 6) {
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> In this round you got "+ rndhra.score+ " points. Dude, what were you doing?! ";
}
...
function generate(){
    ...
    if( Math.abs((hracLeft + hracHeight) - (rndbodLeft + rndbodHeight)) <= (rndbodHeight + hracHeight) && Math.abs((hracTop + hracHeight) - (rndbodTop + rndbodHeight)) <= (rndbodHeight + hracHeight) ){
        rndhra.score++;
        document.getElementById("modaltext").innerHTML = "Your score: "+rndhra.score+ "<br /> Your highscore: "+ highscore;
