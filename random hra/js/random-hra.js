...
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> V tomto kole jsi nasbíral "+ rndhra.score+ " bodů. Není to špatné, ale dá se to ještě zlepšit."
} else if (rndhra.score > 20) {
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> V tomto kole jsi nasbíral "+ rndhra.score+ " bodů. Velmi dobrý výsledek. Gratulace. ";
} else if (rndhra.score < 6) {
var msg = "<img src='img/logo.png' width='100%' height='100%'><h1> Game OVER </h1><br /> <p id='gmvrmsg'> V tomto kole jsi nasbíral "+ rndhra.score+ " bodů. Cos dělal kámo?! ";
}
...
if(highscore !== null){
    if (score > highscore) {
        ...
        alert("Máte nové nejvyšší skóre: "+score+" vaše předchozí nejvyšší skóre bylo: "+highscore);     
    } else {
    }
}
else{
...
function generate(){
    ...
    if( Math.abs((hracLeft + hracHeight) - (rndbodLeft + rndbodHeight)) <= (rndbodHeight + hracHeight) && Math.abs((hracTop + hracHeight) - (rndbodTop + rndbodHeight)) <= (rndbodHeight + hracHeight) ){
        rndhra.score++;
        document.getElementById("modaltext").innerHTML = "Vaše skóre: "+rndhra.score+ "<br /> Vaše nejvyšší skóre: "+ highscore;
